...
//     });
//   });
  var donors_path = '/donors';
  describe("GET donors_path", function() {
    it("knows about the route", function(done) {
      agent.get(donors_path).set('Accept', 'application/json')
    ...
    console.log(agent.get(donors_path.set('Accept','application/json')));
//
