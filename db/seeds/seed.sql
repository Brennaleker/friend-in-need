...
\COPY organizations(id,user_id,organization_name,blurb,population_served,shipping_address_1,shipping_address_2,shipping_city,shipping_state,shipping_postal_code) from './db/seeds/organizations.csv' WITH CSV;
TRUNCATE TABLE items;
\COPY items(id,project_id,name,url,description,quantity,price_per,total) from './db/seeds/items.csv' WITH CSV;
TRUNCATE TABLE projects;
\COPY projects(id,organization_id,title,description,approval_status,funding_status,shipping_status,total) from './db/seeds/projects.csv' WITH CSV;
